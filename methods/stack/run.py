#!/usr/bin/env python3
"""Unified entry point for STACK embedding-based deconvolution.
...
Usage:
    ...
    python methods/stack/run.py --config configs/default.yaml --mode predict \\
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="STACK embedding-based deconvolution: train or predict",
